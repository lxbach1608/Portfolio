      ...
      <section className={cx("hero")}>
        ...
        >
          <p>
            ...
            building product and based in Ho Chi Minh City (HCMC), Viet Nam 📍
          </p>
        </div>
            ...
            <div className={cx("desc")}>
              <h3>
                ...
                <span className={cx("company")}>
                  &nbsp;@&nbsp;
                  <a className={cx("inline-link")}>Upstatement</a>
                </span>
              </h3>
              <p className={cx("range")}>May 2021 - Present</p>
        ...
        <ul className={cx("assignment-list")}>
          ...
          >
            <div className={cx("assignment-content")}>
              ...
              <div className={cx("assignment-desc")}>
                <p>
                  A minimal, dark blue theme for VS Code, Sublime Text, Atom,
                  iTerm, and more. Available on Visual Studio Marketplace,
                  Package Control, Atom PackageManager, and npm.
                </p>
              </div>

              <ul className={cx("assignment-tech-list")}>
                <li>Java</li>
                <li>JSP</li>
                <li>VS Code</li>
                <li>Atom</li>
...
//             <br />
//             <span className={cx("text sec-text")}>Fullstack Developer</span>
//           </div>
